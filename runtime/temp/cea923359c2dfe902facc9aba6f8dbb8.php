<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"C:\phpStudy\WWW\php5\public/../application/home/view/default/life\life_detail.html";i:1507534555;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        <div class="blank"></div>
        <h3 class="noticeDetailTitle"><strong><?php echo $life['title']; ?></strong></h3>
        <div class="noticeDetailInfo"><?php echo $life['name']; ?></div>
        <div class="noticeDetailInfo">发布时间：<?php echo date("Y-m-d H:i:s",$life['create_time']); ?></div>
