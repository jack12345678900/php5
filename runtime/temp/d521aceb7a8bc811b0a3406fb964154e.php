<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"C:\phpStudy\WWW\php5\public/../application/admin/view/default/management\add.html";i:1506682901;s:78:"C:\phpStudy\WWW\php5\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <form action="<?php echo url(''); ?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <textarea name="intro" class="textarea" style="width: 390px"></textarea>
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">状态<span class="check-tips"></span></label>
            <div class="controls">
               未处理: <input type="radio" name="status" value="1">
                已受理:<input type="radio" name="status" value="0">
            </div>
        </div>
        <div class="form-item">
