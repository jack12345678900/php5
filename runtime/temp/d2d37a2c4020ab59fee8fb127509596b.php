<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"C:\phpStudy\WWW\php5\public/../application/home/view/default/notice\index.html";i:1507706731;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    var loadpage=function (num) {
        $('.btn_load').remove();
        $.get("<?php echo url('notice/ajaxpage'); ?>",{page:num},function (data) {
            $('#content').append(data);
        });
    }
    loadpage(1);
