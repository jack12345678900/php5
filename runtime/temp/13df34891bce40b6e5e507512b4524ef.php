<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"C:\phpStudy\WWW\php5\public/../application/home/view/default/yezhurenzheng\index.html";i:1507465051;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        <form action="" method="post">
            ...
            <div class="form-group">
                <button id="submit" class="btn btn-primary onlineBtn">确认提交</button>
            </div>
        </form>
    </div>
</div>
