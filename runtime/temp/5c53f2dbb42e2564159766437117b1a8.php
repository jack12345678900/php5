<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"C:\phpStudy\WWW\php5\public/../application/admin/view/default/diaocha\add.html";i:1507447081;s:78:"C:\phpStudy\WWW\php5\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-title">
    <h2><?php echo isset($info['id'])?'编辑':'新增'; ?>调查问卷</h2>
</div>
<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
    <div class="form-item">
        <label class="item-label">问卷名称<span class="check-tips">（名称）</span></label>
        <div class="controls">
            <input type="text" class="text input-large" name="name" value="<?php echo (isset($info['name']) && ($info['name'] !== '')?$info['name']:''); ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">截止时间<span class="check-tips">（时间）</span></label>
        <div class="controls">
            <input type="text" class="text input-large" name="update_time" value="<?php echo (isset($info['update_time']) && ($info['update_time'] !== '')?$info['update_time']:''); ?>">
        </div>
    </div>
    <!--<div class="form-item">-->
    ...
    <!--</div>-->
    <div class="form-item">
        <label class="item-label">简述<span class="check-tips">（简述）</span></label>
        <textarea name="intro" rows="8" cols="50"><?php echo (isset($info['intro']) && ($info['intro'] !== '')?$info['intro']:''); ?></textarea>
    </div>
    <div class="form-item">
        <label class="item-label">上传图片<span class="check-tips">（图片）</span></label>
        <div class="controls">
            <input type="file" class="text input-large" name="path" value="<?php echo (isset($info['path']) && ($info['path'] !== '')?$info['path']:''); ?>">
        </div>
    </div>
    <div class="form-item">
    ...
    <div class="form-item">
        <label class="item-label">参与人数<span class="check-tips">（人数）</span></label>
        <div class="controls">
