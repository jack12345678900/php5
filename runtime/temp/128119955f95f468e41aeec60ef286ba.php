<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"C:\phpStudy\WWW\php5\public/../application/home/view/default/baoxiu\index.html";i:1507362390;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        <form action="<?php echo url(''); ?>" method="post" class="form-horizontal">
            ...
            <!--</div>-->
            <div class="form-group">
                <button  id="submit" type="submit" class="btn btn-primary onlineBtn">确认提交</button>
            </div>
        </form>
    </div>
</div>
