<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"C:\phpStudy\WWW\php5\public/../application/admin/view/default/diaocha\index.html";i:1507457661;s:78:"C:\phpStudy\WWW\php5\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="data-table table-striped">
    <table>
        ...
        <tbody>
        <?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$diaocha): $mod = ($i % 2 );++$i;?>
        <tr>
            <td><input class="ids row-selected" type="checkbox" name="" id="" value="<?php echo $activity['id']; ?>"> </td>
            <td><?php echo $diaocha['id']; ?></td>
            <td><?php echo $diaocha['name']; ?></td>
            <td><?php echo date("Y-m-d H:i:s",$diaocha['update_time']); ?></td>
            <td><?php if($diaocha['status'] == '1'): ?>
                待处理
                <?php else: ?>
               已处理
                <?php endif; ?></td>
            <td><?php echo $diaocha['sn']; ?></a></td>
            <td>
                <a title="编辑" href="<?php echo url('edit?id='.$diaocha['id'].'&pid='.$pid); ?>">编辑</a>
                <a class="confirm ajax-get" title="删除" href="<?php echo url('del?id='.$diaocha['id']); ?>">删除</a>
            </td>
        </tr>
