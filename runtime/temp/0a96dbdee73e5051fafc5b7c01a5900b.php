<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"C:\phpStudy\WWW\php5\public/../application/admin/view/default/yezhurenzheng\index.html";i:1507466660;s:78:"C:\phpStudy\WWW\php5\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="cf">
    <div class="fl">
        <button class="btn ajax-post confirm" url="<?php echo url('changeStatus?method=delManagement'); ?>" target-form="ids">删 除</button>
    </div>
...
<div class="data-table table-striped">
    <table class="">
        ...
        <tr>
            <td><input class="ids" type="checkbox" name="" value="<?php echo $vo['id']; ?>" /></td>
            <td><?php echo $vo['name']; ?> </td>
            <td><?php echo $vo['sn']; ?></td>
            <td><?php echo $vo['status']; ?></td>
            <td><?php echo $vo['tel']; ?></td>
            <td><?php echo $vo['id_card']; ?></td>
            <td><?php echo !empty($vo['sta']) && $vo['sta']==1?"已审核":"待审核"; ?>
                <a href="<?php echo url('edit?method=edit&id='.$vo['id']); ?>" id="tongguo">审核</a>
            </td>
            <td>
...
<script type="text/javascript">
    ...
    //导航高亮
    highlight_subnav('<?php echo url('yezhurenzheng/index'); ?>');
