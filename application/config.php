...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => '_pl(UdbZozf2MR<,/h!O-g#8${FJ36Y>AwiSx%)L', //默认数据加密KEY
	'data_cache_key'=> '_pl(UdbZozf2MR<,/h!O-g#8${FJ36Y>AwiSx%)L',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'_pl(UdbZozf2MR<,/h!O-g#8${FJ36Y>AwiSx%)L', //加密KEY
